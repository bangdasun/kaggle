...
## ----visualize data without missing value--------------------------------
...
## ----extract Fare without missing value----------------------------------
...
## ----visualize fare conditioning on Survived-Pclass-Sex-----------------
...
## ----visualize Age with other related features---------------------------
...
## ----preparation for Age imputation--------------------------------------
...
# extract
letter <- sapply(c(train$Ticket %>% as.character(), 
                   test$Ticket %>% as.character()), extract_letters)
number <- sapply(c(train$Ticket %>% as.character(), 
