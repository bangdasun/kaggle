...
def multilabel_fscore(y_true, y_pred):
    """ @author: onodera @address: https://www.kaggle.com/onodera
    ex1:
    y_true = [1, 2, 3]
    y_pred = [2, 3]
    return: 0.8
...
# -------------------------------------------------------------
# --- this is from public kernel: applying F1-optimization ----
# --- @author: cpmp @address: https://www.kaggle.com/cpmpml ---
# -------------------------------------------------------------
